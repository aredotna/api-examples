      ...
      <Box>
        <Flex direction="column" gap="4">
          <ContentTypeFilter
            ...
            onChange={(value) => dispatch({ type: 'SET_SEARCH_TYPE', searchType: value })}
          ...
          {state.searchType === 'Block' && (
            <ContentTypeFilter
              ...
              onChange={(value) => dispatch({ type: 'SET_BLOCK_SUBTYPE', blockSubtype: value })}
          ...
          <Flex gap="4" wrap="wrap">
            ...
            <Select.Root
              value={state.sort}
              onValueChange={(value) => dispatch({ type: 'SET_SORT', sort: value as SearchSort })}
            >
              <Select.Trigger />
